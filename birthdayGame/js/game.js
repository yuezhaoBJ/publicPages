var Game = (function (name) {
    ...
    Game.prototype = {
        ...
        update: function () {
            ...
            animationFrameId = window.requestAnimationFrame(this.update.bind(this));
        },
        ...
        isSame: function (before, after) {
            return this.getItem(before).val !== null && this.getItem(after).val !== null && this.getItem(before).val[0] === this.getItem(after).val[0];
        },
        ...
        checkDeadlock: function () {
            ...
            var filter = function (i) {
                return cell.filter(function (el) {
                    return el.val && el.val[0] === i.toString();
                });
            };
            for (var i = 0; i < count; i++) {
                var result = filter(i);
